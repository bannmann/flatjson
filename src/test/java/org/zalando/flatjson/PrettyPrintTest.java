...
public class PrettyPrintTest
{
    ...
    @Test
    public void prettyPrintLiteralNull()
    {
        Json json = Json.NULL;
        assertEquals("null", json.prettyPrint());
    }
    ...
    @Test
    public void prettyPrintLiteralTrue()
    {
    ...
    @Test
    public void prettyPrintLiteralNumber()
    {
    ...
    @Test
    public void prettyPrintLiteralString()
    {
    ...
    @Test
    public void prettyPrintEmptyArray()
    {
    ...
    @Test
    public void prettyPrintLiteralEmptyArray()
    {
    ...
    @Test
    public void prettyPrintLiteralArray()
    {
    ...
    @Test
    public void prettyPrintLiteralNestedArray()
    {
    ...
    @Test
    public void prettyPrintEmptyObject()
    {
        Json json = Json.parse("{}");
        assertEquals("{}", json.prettyPrint());
    }
    ...
    @Test
    public void prettyPrintLiteralEmptyObject()
    {
    ...
    @Test
    public void prettyPrintLiteralObject()
    {
        Json json = Json.object();
        json.asObject()
            .put("foo", Json.value(23));
        assertEquals("{\n\t\"foo\": 23\n}", json.prettyPrint("\t"));
    }
    ...
    @Test
    public void prettyPrintLiteralNestedObject()
    {
        Json json = Json.object();
        json.asObject()
            .put("foo", Json.object());
    ...
    @Test
    public void prettyPrintCompact()
    {
        Json json = Json.object();
        json.asObject()
            .put("foo", Json.array(Json.TRUE, Json.FALSE));
